      ...
      <CrudTable
        ...
        fields={[
          ...
          { key: "category", label: "التصنيف", type: "select", options: [
            { value: "إنجازات ومستجدات", label: "إنجازات ومستجدات" },
            { value: "شراكات واتفاقيات", label: "شراكات واتفاقيات" },
            { value: "فعاليات وتدشين", label: "فعاليات وتدشين" },
            { value: "زيارات ولقاءات", label: "زيارات ولقاءات" },
            { value: "مبادرات وبرامج", label: "مبادرات وبرامج" },
            { value: "إعلانات رسمية", label: "إعلانات رسمية" },
          ]},
